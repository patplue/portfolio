    ...
    <div>
      <div className="manager-block animate">
        ...
        <div className="home-text-block">
          <h1 className="manager-headline">Hi, I'm Patrick Plue.<br/> A Manager, Teacher, Student.</h1>
          <div className="manager-about-me">
            <p>
            Welcome to my portfolio,<br/>
            <br/>
            I was able to gather <span className="highlight"> Experience</span> in a lot of different scenarios. 
            For example during my 10 year <span className="highlight"> Career</span> in retail I was in every position 
            from a<span className="highlight"> Retail Clerk</span>  all the way up to the position of the<span className="highlight"> Store Manager </span> 
            leading a successful team. I was certified to<span className="highlight"> Teach</span> apprentices and 
