        ...
        <div className="home-text-block">
          ...
          <div className="manager-about-me">
            <p>
              ...
              <br />
              <br />I gathered <span className="highlight">Experience</span> in
              a lot of different positions. During my 10 year Career in retail I
              made my way up from a{" "}
              <span className="highlight">Retail Clerk</span> to{" "}
              <span className="highlight">Store Manager</span> leading a
              successful team. I was certified to{" "}
