...
const App = () => {
  console.log(
    "%c Hi, I'm flattered that you took the time to check out my code. If you want to talk about it send me a message via contact form. ;)",
    "color: #fbaf00; font-size: 25px"
  );
